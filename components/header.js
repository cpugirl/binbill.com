						...
						<div className="container navbar-inner">
							<div className="logo-wrapper">
								<a href="/" className="logo">
									<img src='/static/images/logo.svg' alt="logo" className="logo-image" />
								</a 	>
							</div>
							<div className={isMobileMenuVisible ? "mobile-menu-visible" : ""}>
								...
								>
									<div className="header-menu">
										<a
											className={
												activeIndex === 0 ? "item active" : "item"
											}
										...
										<a
											className={
												activeIndex === 1 ? "item active" : "item"
											}
										...
										<a
											className={
												activeIndex === 2 ? "item active" : "item"
											}
										...
										<a
											className={
												activeIndex === 3 ? "item active" : "item"
											}
										...
										<a
											className={
												activeIndex === 4 ? "item active" : "item"
											}
					...
					>
						<div className="row">
							...
							<div className="col-sm-6 header-mobile-img-container">
								<img className="header-mobile-img" src='/static/images/phone-3-x-132-d-989-c.png' />
								{/* <Slider {...settings}
