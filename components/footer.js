					...
					<div className="container text-center">
						<div className="row">
							<div className="col-lg-2 col-md-2 col-sm-2 footer-logo">
								<img src='/static/images/logo-492817-e-5.svg' alt="footerlogo" />
							</div>
					...
					<div className="container bottom-footer">
						<div className="row">
							<div className="col-lg-6 col-md-6 col-sm-6">
								<p className="copyright pull-left">© BIN BILL SERVICES PRIVATE
                        LIMITED, {year}. ALL RIGHTS RESERVED</p>
							</div>
							...
							<div className="col-lg-1 col-md-1 col-sm-1 col-xs-3">
								<a href="https://www.linkedin.com/company/13320885/">
									<img src='/static/images/fill-88.svg' alt="Linked In logo" className="in-logo" />
								</a>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-xs-12">
								<div className="We-would-love-to-hea ">We would love to hear from you</div>
							</div>
							<div className="col-xs-12">
								<div className="We-are-here-to-provi">We are here to provide you more information, answer any questions you may have and create a more effective solution to your needs. Get in touch!</div>
							</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-xs-12 text-center">
								<p className="copyright">© BIN BILL SERVICES PRIVATE
                    LIMITED, {year}. ALL RIGHTS RESERVED</p>
							</div>
						</div>
					</div>
