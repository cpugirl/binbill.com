			...
			<div>
              ...
              <div className="playstore-section">
					...
					<div className="container">
						<div className="row about-item">
							<div className="col-md-6 text-center">
								<img src='/static/images/group-29.svg' className="about-image" />
							</div>
							<div className="col-md-6">
								...
								<div className="description2">
									<p>
										While clicking a selfie one day, we thought how easy our
                        lives have become, with the advent of smart phones. At the
                        same time, we found one of us struggling with pile of bills,
                        and hassling his way to his desk with huge files, filled
                        with nothing but bills/invoice. The realisation that stuck
                        us at that time, led to the formation of what we today call
                        as BinBill.
                      </p>
									<p>
										Apart from becoming a part and parcel of shopping tours for
                        many, BinBill has helped multiple individuals with their
                        eased out after sales communication. Brand communication is
                        yet another feature that BinBill application has provided to
                        the users, which allows them to communicate with brands for
                        various information related to the products. Product card
                        enables user to stay updated with all the information
                        related to their products, be it the date of manufacturing
                        or purchase, we have it all. The feature loved the most by
                        all the users, is the eHome, their virtual safe for securely
                        storing all their bills and important documents.
                      </p>
									<p>
						...
						<div className="row about-item">
							<div className="col-md-6 text-center about-item-2-image">
								<img src='/static/images/group-33.png' className="about-image" />
							</div>
							<div className="col-md-6 about-item-2-content">
								...
								<div className="description2">
									<p>
										No more of running here and there for exercising your rights
                        as a consumer. Use BinBill, and fill in all the gaps,
                        connect with brands, get product info, timely reminders,
                        hassle free after sales services, and access your
                        bills/important documents anytime/anywhere.
                      </p>
                      ...
                      give you stress. Just use BinBill!
								...
								<div className="playstore-badge">
									<a href="http://play.google.com/store/apps/details?id=com.bin.binbillcustomer">
										<img src='/static/images/playstore-badge.png' alt="Play Store Badge" />{" "}
									</a>
								</div>
							</div>
						</div>
				...
				.know-more {
					...
					width: 170px;
					border-radius: 26px;
					background-image: -webkit-linear-gradient(190deg, #ff802e, #ff652e);
